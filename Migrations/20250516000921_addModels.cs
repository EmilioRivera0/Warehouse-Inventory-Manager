        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarehouseUserId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistorySet", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistorySet_AspNetUsers_WarehouseUserId",
                        column: x => x.WarehouseUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HistorySet_ProductsSet_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistorySet_ProductId",
                table: "HistorySet",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_HistorySet_WarehouseUserId",
                table: "HistorySet",
